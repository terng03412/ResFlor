...
class DataGenerator():
    ...
    def __init__(self, source, batch_size, charset, max_text_length, predict=False):
        ...
        for pt in self.partitions:
            ...
            self.dataset[pt]['gt'] = [x.decode()
                                      for x in self.dataset[pt]['gt']]
    ...
    def next_train_batch(self):
        ...
        while True:
            ...
            y_train = pad_sequences(
                y_train, maxlen=self.tokenizer.maxlen, padding="post")
    ...
    def next_valid_batch(self):
        ...
        while True:
            ...
            y_valid = pad_sequences(
                y_valid, maxlen=self.tokenizer.maxlen, padding="post")
